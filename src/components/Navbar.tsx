...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white shadow-lg border-b border-border">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="py-4 space-y-2 bg-white rounded-b-2xl border-t border-border">
            {menuItems.map((item) => (
              <a
                key={item.href}
                href={item.href}
