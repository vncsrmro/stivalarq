...
const Expertise = () => {
  ...
  return (
    <section id="expertise" className="py-16 md:py-24 bg-gradient-to-br from-neutral-50 via-background to-teal-50/30 relative overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
          {/* Gallery */}
          <div 
            className="order-2 md:order-1 animate-scale-in"
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-[var(--shadow-strong)] bg-neutral-900">
              ...
              <button
                onClick={scrollPrev}
                className="absolute left-3 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center shadow-lg hover:bg-white transition-all duration-300 hover:scale-110"
                aria-label="Anterior"
              >
              ...
              <button
                onClick={scrollNext}
                className="absolute right-3 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center shadow-lg hover:bg-white transition-all duration-300 hover:scale-110"
                aria-label="Próximo"
              >
